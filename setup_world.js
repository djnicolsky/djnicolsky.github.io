...
var World = {
		...
		var PLT2D = [];
			...
			World.dt = parseFloat(ModelSetup('SPACE','dt',ModelScript));
			var acclerator = parseFloat(ModelSetup('SPACE','Accelerator',ModelScript));
			if(acclerator > 0) World.dt /= acclerator;
			World.log10dt = Math.log(World.dt)/Math.log(10);
